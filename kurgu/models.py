...
class KJ(models.Model):
    ...
    tel = models.CharField(default='', blank=True,max_length=60,verbose_name="Tel no")
    ...
    play_time_as_minuate = models.CharField(default='', blank=True,max_length=60,verbose_name="Yayın dakikasi")
